...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MyLibertyCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"mylibertycoin.com","198.1.95.122"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MyLibertyCoin is probably already running."), addrBind.ToString().c_str());
        else
