...
static const int64 MAX_MONEY = 2100000000 * COIN; // MyLibertyCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 3) / 250; // MyLibertyCoin: Priority cutoff is 2 MyLibertyCoin day / 250 bytes.
    }
